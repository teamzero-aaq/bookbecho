...
echo'										</div>
                            ...
                            <div class="mo_otp_note">
                                ...
                                <div id="wp_sms_integration" hidden >
                                    '.mo_( " <i>If you wish to integrate the plugin with your form then you can follow our documentation. Contact us at info@xecurify.com or use the support form to send us a query.</i>").'
                                </div>
                            </div>    
                            <div class="mo_otp_note">
                                    ...
                                    <div >
                                        ...
                                        <div style="margin-top:2%;text-align:center">
                                            <input  type="button" 
                                                    ...
                                                    onclick="extraSettings(\''.MoConstants::HOSTNAME.'\',\'/moas/viewtransactions\');" 
